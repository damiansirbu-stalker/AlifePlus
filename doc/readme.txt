...
- No accumulation: when an item moves to a destination that already holds the same kind, the move is skipped. Stalkers and stashes do not build duplicate stacks.
