...
- No-accumulation gate. Before placing a section into any destination (NPC inventory, stash, trader, container), check the destination does not already hold that section; skip the place if it does.
