...
| Per-causer reaction counter | TTL counter, sliding window (game-sec) | per causer entity id (shared across all REACTIONS) | 1 / 1 game-hour | ap_core_limiter (check_causer_rate_limit, increment_causer_counter) | MCM cause_max_per_causer |
